...
//                       <p className="h-12 text-base text-gray-700">{position}</p>
//                     </div>
...
//                               <div className="mb-4">
//                                 <p>
//                                   Ambitious and results-driven academic
//                                   professional with broad-based expertise in
//                                   leading teams, establishing departments and
//                                   strengthening organizations. Committed to
...
//                                 </h1>
//                                 <p>
//                                   - Ph.D in Resource Economics from Humboldt
//                                   University, Germany, 2007. <br /> - MA in
//                                   Sustainable Development from Chiang Mai
//                                   University, Thai Lan, 2003. <br /> - BSc in
//                                   Land Management from University of Agriculture
//                                   and Forestry, Ho Chi Minh City, Vietnam, 1996
//                                 </p>
//                               </div>
//                               <div className="mb-4">
//                                 <h1 className="text-2xl font-bold uppercase text-vgu-orange">
...
//                                 </h1>
//                                 <p>
//                                   Dr. Ha Thuc Vien is the Acting President of
//                                   the Vietnamese German University. He is also
//                                   Vice President in charge of Academic Affairs
//                                   cum Director of the VGU's Management Unit
//                                   (VMU, an designated unit to manage the VGU New
//                                   Campus construction under the USD 200 million
//                                   World Bank loaned project).
//                                   <br />
//                                   <br />
//                                   Before joining VGU in 2012, Dr. Vien was the
//                                   Head of Natural Resources and Tourism
//                                   Department and also the founder and Director
//                                   of Center for International Education of Ho
//                                   Chi Minh City University of Agriculture and
//                                   Forestry. His earlier career includes a senior
//                                   lecturer in Resource and Land Economics,
//                                   Resource Management, Land Use and Project
//                                   Management. He has published a number of
//                                   books, book chapters and articles in his
//                                   specialized fields.
//                                 </p>
//                               </div>
//                             </div>
...
// Define the type for a presidential board member

// interface PresidentialBoardMember {
//   name: string;
//   position: string;
//   imageUrl: string;
//   email: string;
